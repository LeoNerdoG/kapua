...
public class KuraBirthCertificateModuleTest extends Assert {
    ...
    @Test(expected = NullPointerException.class)
    public void applicationAddedAndRemovedTest() {
        String applicationId = "Application Id";
        builder.defaultProviders();
        builder.build().applicationRemoved(applicationId);
        builder.build().applicationAdded(applicationId);
        builder.build().applicationRemoved(applicationId);
    }

    @Test(expected = NullPointerException.class)
    public void applicationAddedNUllTest() {
        builder.defaultProviders();
        builder.build().applicationAdded(null);
    }

    @Test(expected = NullPointerException.class)
    public void applicationRemovedNUllTest() {
        builder.build().applicationRemoved(null);
    }

    @Test(expected = NullPointerException.class)
    public void connectedTest() {
        builder.defaultProviders();
        builder.build().connected();
    }
