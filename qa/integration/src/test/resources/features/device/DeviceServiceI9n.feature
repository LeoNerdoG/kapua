...
Feature: Device Registry Integration
  ...
  Scenario: Creating Device With Unique Name
  Login as kapua-sys, go to devices, create device with unique name.
  ...
  Scenario: Creating Device With Non-unique Name
  Login as kapua-sys, go to devices, create device with non-unique name.
  Kapua should return errors.
    ...
    When A devices such as
      | clientId | displayName  | modelId         | serialNumber |
      | Device1  | testGateway1 | ReliaGate 10-21 | 99541234ABC  |
    Then An exception was thrown
    And I logout

  Scenario: Creating Device With Short Name
  Login as kapua-sys, go to devices, create device with short name.
  Kapua should not return any errors.
  ...
  Scenario: Creating Device With No Name
  Login as kapua-sys, go to devices, create device with no name.
  Kapua should return errors.
  ...
  Scenario: Creating Device With Name That Contains Permitted Symbols
  Login as kapua-sys, go to devices, create device with permitted symbols in name.
  ...
  Scenario: Creating Device With Name That Contains Invalid Symbols
  Login as kapua-sys, go to devices, create device with invalid symbols in name.
  Kapua should return errors.
    When I login as user with name "kapua-sys" and password "kapua-password"
    Given Account
      | name     | scopeId |
    ...
    And A device such as
      | clientId | displayName  | modelId         | serialNumber |
      | dev*123  | testGateway3 | ReliaGate 10-20 | 12541234ABC  |
    Then An exception was thrown
    And I logout

  Scenario: Creating Device With Long Name
  Login as kapua-sys, go to devices, create device with long (255) name.
  Kapua should not return any errors.
  ...
  Scenario: Creating Device With Too Long Name
  Login as kapua-sys, go to devices, create device with too long (256) name.
  Kapua should not return any errors.
  ...
  Scenario: Creating Device With Non-unique Display Name
  Login as kapua-sys, go to devices, create device with unique display name.
  Kapua should not return errors.
  ...
  Scenario: Creating Device With Unique Display Name
  Login as kapua-sys, go to devices, create device with unique display name and another with same display name.
  Kapua should not return errors. Duplicates are allowed.
  ...
  Scenario: Creating Device With Short Display Name
  Login as kapua-sys, go to devices, create device with short display name.
  Kapua should not return errors. Duplicates are allowed.
    When I login as user with name "kapua-sys" and password "kapua-password"
    Given Account
      | name     | scopeId |
  ...
  Scenario: Creating Device With Long Display Name
  Login as kapua-sys, go to devices, create device with long display name.
  Kapua should not return errors.
  ...
  Scenario: Creating Device With Too Long Display Name
  Login as kapua-sys, go to devices, create device with too long display name.
  Kapua should not return errors.
  ...
  Scenario: Creating Device With Permitted Symbols Display Name
  Login as kapua-sys, go to devices, create device with special symbols display name.
  Kapua should not return errors. All symbols are permitted.
  ...
  Scenario: Creating Device With Disabled Status
  Login as kapua-sys, go to devices, create device with status set to DISABLED.
  Kapua should not return errors.
  ...
  Scenario: Creating Device With Enabled Status
  Login as kapua-sys, go to devices, create device with status set to ENABLED.
  Kapua should not return errors.
  ...
  Login as kapua-sys, go to devices, create device.
  Try to edit devices name.
  ...
  Login as kapua-sys, go to devices, create device.
  Try to edit devices status to ENABLED.
  Kapua should not return errors.
  ...
  Try to delete the device. Kapua should not return any errors.
    ...
    When A device such as
      | clientId | displayName  | modelId         | serialNumber | status  |
      | dev-123  | displayNam22 | ReliaGate 10-20 | 12541234ABC  | ENABLED |
    And I delete the device with the client id "dev-123"
    When I search for a device with the client ID "dev-123"
  ...
  Login as kapua-sys, go to devices, create device with disabled status.
  Try to delete the device. Kapua should not return any errors.
  ...
  Scenario: Search By Client ID And Get No Matches
  Login as kapua-sys, go to devices, create devices.
  Try to find it by full Client ID.
  One device should be found.
  ...
  Scenario: Search By Client ID And Get No Matches
  Login as kapua-sys, go to devices, create devices.
  Try to find it by one letter of Client ID.
  ...
  Scenario: Search By Display Name And Get One Match
  Login as kapua-sys, go to devices, create a device.
  ...
  Scenario: Search By Specific Display Name
  Login as kapua-sys, go to devices, create a device.
  Try to find it by specific Display Name.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Serial Number.
  One device should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by specific Serial Number.
  1 device should be found.
  ...
  Scenario: Search By Status And Get One Match
  Login as kapua-sys, go to devices, create a device.
  ...
  Scenario: Search By Status And Get No Matches
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Status.
  No devices should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Client ID and Display Name.
  Devices should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Client ID and Serial Number.
  Devices should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Client ID and Status.
  Devices should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Display Name and Serial Number.
  Devices should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Client ID, Display Name and Status.
  Devices should be found.
  ...
  Login as kapua-sys, go to devices, create a device.
  Try to find it by Serial Number, Display Name and Status.
  Devices should be found.
