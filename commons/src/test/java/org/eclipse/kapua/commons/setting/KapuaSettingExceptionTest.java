...
public class KapuaSettingExceptionTest extends Assert {
    ...
    public void extendedConstructorWithObjectArgTest() {
        ...
        for (Object value : arguments) {
            ...
            assertTrue("Expected and actual values should be the same!", kapuaSettingException.getCode().toString().equals("INVALID_RESOURCE_NAME") && kapuaSettingException.getMessage().equals("Error: " + value));
        }
    }
    ...
    public void extendedConstructorWithNullObjArgTest() {
        ...
        assertTrue("Expected and actual values should be the same!", kapuaSettingException.getCode().toString().equals("INVALID_RESOURCE_NAME") && kapuaSettingException.getMessage().equals("Error: " + null));
    }
    ...
    public void extendedConstructorWithThrowableAndNullObjArgTest() {
        ...
        assertTrue("Expected and actual values should be the same!", kapuaSettingException.getCode().toString().equals("INVALID_RESOURCE_NAME") && kapuaSettingException.getCause().equals(throwable) && kapuaSettingException.getMessage().equals("Error: " + null));
    }
    ...
    public void extendedConstructorWithNullThrowableAndNullObjArgTest() {
        ...
        assertTrue("Expected and actual values should be the same!", kapuaSettingException.getCode().toString().equals("INVALID_RESOURCE_NAME") && kapuaSettingException.getCause() == null && kapuaSettingException.getMessage().equals("Error: " + null));
    }
    ...
    public void extendedConstructorWithThrowableAndObjectArgTest() {
        ...
        for (Object value : arguments) {
            ...
            assertTrue("Expected and actual values should be the same!", kapuaSettingException.getCode().toString().equals("INVALID_RESOURCE_NAME") && kapuaSettingException.getCause().equals(throwable) && kapuaSettingException.getMessage().equals("Error: " + value));
        }
    }
}
