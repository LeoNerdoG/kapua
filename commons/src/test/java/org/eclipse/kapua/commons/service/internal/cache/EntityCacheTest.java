...
public class EntityCacheTest extends Assert {
    ...
    public void entityCacheTest() {
        ...
        assertThat(entityCache, IsInstanceOf.instanceOf(EntityCache.class));
    ...
    public void putListTest() {
        ...
        Serializable key = new ComposedKey(scopeId1, null);
        Serializable id = new ComposedKey(scopeId1, key);
        KapuaListResult<KapuaEntity> list = new KapuaListResultImpl<KapuaEntity>();

        entityCache.putList(scopeId, id, list);
        entityCache.putList(scopeId, null, list);
        entityCache.putList(scopeId, id, null);
        entityCache.putList(scopeId, null, null);
        entityCache.putList(null, id, list);
        entityCache.putList(null, null, list);
        entityCache.putList(null, id, null);
        entityCache.putList(null, null, null);
    }
