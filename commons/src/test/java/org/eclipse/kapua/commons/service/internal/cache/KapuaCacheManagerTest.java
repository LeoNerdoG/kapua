...
public class KapuaCacheManagerTest extends Assert {
    ...
    public void getCacheTest() {
        ...
        assertNotNull("Cache object expected", KapuaCacheManager.getCache(cacheName));
        assertThat(KapuaCacheManager.getCache(cacheName), IsInstanceOf.instanceOf(Cache.class));
