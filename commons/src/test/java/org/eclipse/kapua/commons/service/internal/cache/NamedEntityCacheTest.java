...
public class NamedEntityCacheTest extends Assert {
    ...
    public void namedEntityCacheTest() {
        ...
        assertNotNull(namedEntityCache);
        assertEquals(expectedNameCache, namedEntityCache.nameCache);
        assertThat(namedEntityCache, IsInstanceOf.instanceOf(NamedEntityCache.class));
