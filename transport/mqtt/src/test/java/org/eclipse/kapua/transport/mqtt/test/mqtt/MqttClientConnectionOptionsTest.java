...
public class MqttClientConnectionOptionsTest extends Assert {
    ...
    public void setAndGetClientIdTest() {
        ...
        for (String value : stringValues) {
            ...
            assertEquals("Expected and actual values are not equals!", value, connectOptions.getClientId());
        }
    }
    ...
    public void setAndGetUsernameTest() {
        ...
        for (String value : stringValues) {
            ...
            assertEquals("Expected and actual values are not equals!", value, connectOptions.getUsername());
        }
    }
    ...
    public void setAndGetPasswordTest() {
        ...
        for (String value : stringValues) {
            ...
            assertEquals("Expected and actual values are not equals!", charValue, connectOptions.getPassword());
        }
    }
    ...
    public void setAndGetURITest() throws URISyntaxException {
        ...
        for (URI value : uriPermittedFormats) {
            ...
            assertEquals("Expected and actual values are not equals!", value, connectOptions.getEndpointURI());
        }
    }
