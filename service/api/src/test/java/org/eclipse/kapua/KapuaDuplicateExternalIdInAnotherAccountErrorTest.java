...
public class KapuaDuplicateExternalIdInAnotherAccountErrorTest extends Assert {
    ...
    public void kapuaDuplicateExternalIdInAnotherAccountErrorTest() {
        for (int i = 0; i < duplicateExternalId.length; i++) {
            KapuaDuplicateExternalIdInAnotherAccountError kapuaDuplicateExternalIdInAnotherAccountError = new KapuaDuplicateExternalIdInAnotherAccountError(duplicateExternalId[i]);
            ...
            assertEquals("Expected and actual values should be the same.", "An entity with the same external id " + duplicateExternalId[i] + " already exists in another account.", kapuaDuplicateExternalIdInAnotherAccountError.getMessage());
        }
    }
