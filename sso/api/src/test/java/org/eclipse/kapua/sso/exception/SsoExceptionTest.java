...
public class SsoExceptionTest extends Assert {
    ...
    public void ssoExceptionKapuaErrorCodeParameterTest() {
        for (int i = 0; i < kapuaErrorCodes.length; i++) {
            SsoException ssoException = new ActualSsoException(kapuaErrorCodes[i]);
            assertNull("Null expected.", ssoException.getCause());
            assertEquals("Expected and actual values should be the same.", kapuaErrorCodes[i], ssoException.getCode());
            assertEquals("Expected and actual values should be the same.", kapuaErrorMessage, ssoException.getKapuaErrorMessagesBundle());
    ...
    public void ssoExceptionKapuaErrorCodeObjectParametersTest() {
        ...
        for (int i = 0; i < kapuaErrorCodes.length; i++) {
            SsoException ssoException = new ActualSsoException(kapuaErrorCodes[i], argument1, argument2, argument3);
